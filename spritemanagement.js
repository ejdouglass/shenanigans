...
//Welp, this does weird things! 350 works fine, 250 becomes 25, 150 becomes 1...
var numdefaultx = Number(defaultx.substring(defaultx[0], defaultx[defaultx.length - 3]));
var numdefaulty = Number(defaulty.substring(defaulty[0], defaulty[defaulty.length - 3]));
document.getElementById("defaultframewidth").value = parseInt(defaultx);
document.getElementById("defaultframeheight").value = parseInt(defaulty);
